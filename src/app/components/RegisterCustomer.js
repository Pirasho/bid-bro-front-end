...
const RegisterCustomer = ({ isOpen, onClose, setSignInModalOpen }) => {
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-60 z-50">
      <div className="relative bg-white bg-opacity-80 rounded-lg shadow-lg p-6 max-w-md w-full">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button 
            type="submit" 
            className="bg-blue-500 hover:bg-blue-600 text-white font-bold h-10 rounded w-full" 
            disabled={loading}
          >
        ...
        <div className="text-center mt-4">
          <p className="text-sm">
            ...
            <button onClick={() => setSignInModalOpen(true)} className="text-blue-500 font-bold hover:underline">
              Sign In
            </button>
          </p>
        </div>
