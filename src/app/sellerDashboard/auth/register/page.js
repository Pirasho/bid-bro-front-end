  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      ...
      try {
        ...
        const response = await fetch('http://localhost:5002/api/seller/register', {
          method: 'POST',
          headers: {
        ...
        window.location.href = '/sellerDashboard/auth/signin';
      } catch (error) {
          ...
          <div className="col-md-6">
            <div className="card p-4">
              <div className="d-flex justify-between align-center">
                <div className="text-body-secondary heading-with-bar fw-bold fs-2">Seller Register</div>
              ...
              <div className="card-body">
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="row mb-1">
                    <div className="col-md-6">
                      <label htmlFor="address" className="form-label fs-4">Shop Name</label>
                      <input
                        type="text"
                        className="form-control"
                        id="shop_name"
                    ...
                    <div className="col-md-6">
                      <label htmlFor="city" className="form-label fs-4">Shop Address</label>
                      <input
                        type="text"
                        className="form-control"
                        id="shop_address"
                  ...
                  <div className="row mb-1">
                    <div className="col-md-6">
                      <label htmlFor="country" className="form-label fs-4">City</label>
                      <input
                        type="text"
                        className="form-control"
                        id="city"
                    ...
                    <div className="col-md-6">
                      <label htmlFor="zip" className="form-label fs-4">Country</label>
                      <input
                        type="text"
                        className="form-control"
                        id="country"
                  ...
                  <div className="mt-3">
                    <p className="text-center">Already have an account? <Link href="/sellerDashboard/auth/signin">Sign in here</Link></p>
                  </div>
                </form>
              </div>
            </div>
