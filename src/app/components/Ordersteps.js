...
const Step = ({ stepNumber, title, isActive }) => {
    return (
        <div className="d-flex justify-content-center align-items-center gap-2">
            {isActive ?
                ...
                : <div className='step-circle rounded-circle '></div>}
            <div className="d-flex justify-content-center align-items-center gap-1">
                <div className=' fs-18  fw-bold'>{stepNumber}</div>
                <div className='text-muted fs-18  fw-semibold'>{title}</div>
            </div>
        </div>
    );
};
